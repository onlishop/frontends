 ...
 * Instead override it in your onlishop.d.ts file.
 *
 * Onlishop API version: 6.7.1.0
 *
 */
type GenericRecord =
  | never
...
export type Schemas = {
  ...
  Criteria: {
    ...
    fields?: string[];
    /** List of filters to restrict the search result. For more information, see [Search Queries > Filter](https://onlishop.stoplight.io/docs/store-api/docs/concepts/search-queries.md#filter) */
    filter?: (
    ...
    /** Search result page */
    page?: number;
    /** Filters that applied without affecting aggregations. For more information, see [Search Queries > Post Filter](https://onlishop.stoplight.io/docs/store-api/docs/concepts/search-queries.md#post-filter) */
    "post-filter"?: (
      | components["schemas"]["SimpleFilter"]
      | components["schemas"]["EqualsFilter"]
      | components["schemas"]["MultiNotFilter"]
  ...
  SalesChannelContext: {
    ...
    itemRounding: {
      /** @enum {string} */
      apiAlias: "onlishop_core_framework_data_abstraction_layer_pricing_cash_rounding_config";
      /** Format: int32 */
      decimals: number;
      /** Format: float */
      interval: number;
...
export type operations = {
  ...
  "readCategoryList post /category": {
    ...
    accept?: "application/json";
    headers?: {
      /** Instructs Onlishop to return the response in the given language. */
  ...
  "readCategory post /category/{navigationId}": {
    ...
    accept?: "application/json";
    headers?: {
      /** Instructs Onlishop to try and resolve SEO URLs for the given navigation item */
