# onlishop/frontends - api-client

[![](https://img.shields.io/npm/v/@onlishop/api-client?color=blue&logo=data:image/svg+xml;base64,)](https://npmjs.com/package/@onlishop/api-client)
[![](https://img.shields.io/github/package-json/v/onlishop/frontends?color=blue&filename=packages%2Fapi-client%2Fpackage.json&label=frontends/api-client&logo=github)](https://github.com/onlishop/frontends/tree/main/packages/api-client)
[![](https://img.shields.io/github/issues/onlishop/frontends/api-client?label=package%20issues&logo=github)](https://github.com/onlishop/frontends/issues?q=is%3Aopen+is%3Aissue+label%3Aapi-client)
[![](https://img.shields.io/github/license/onlishop/frontends?color=blue)](#)

Dynamic and fully typed API Client for Onlishop 6. Usable in any JavaScript and TypeScript project.
You can use types generated from your custom API instance to have autocompletion and type safety.

To generate your own types use [@onlishop/api-gen](https://www.npmjs.com/package/@onlishop/api-gen) CLI.
...
<!-- automd:pm-install name="@onlishop/api-client" -->

```sh
# ✨ Auto-detect
npx nypm install @onlishop/api-client

# npm
npm install @onlishop/api-client

# yarn
yarn add @onlishop/api-client

# pnpm
pnpm install @onlishop/api-client

# bun
bun install @onlishop/api-client

# deno
deno install @onlishop/api-client
```
...
```typescript
import { createAPIClient } from "@onlishop/api-client";

// You can pick types of your current API version, the default one:
import type { operations } from "@onlishop/api-client/store-api-types";
// or - RECOMMENDED - your types generated by [@onlishop/api-gen](https://www.npmjs.com/package/@onlishop/api-gen) CLI:
...
export const apiClient = createAPIClient<operations>({
  baseURL: "https://demo-frontends.onlishop.store/store-api",
...
apiClient.hook("onContextChanged", (newContextToken) => {
  Cookies.set("sw-context-token", newContextToken, {
    ...
    path: "/",
    sameSite: "lax",
    secure: onlishopEndpoint.startsWith("https://"),
  });
});
```
...
```typescript
import { createAdminAPIClient } from "@onlishop/api-client";
```
...
import type {
  operations,
} from "@onlishop/api-client/admin-api-types"; // we take default admin api types from different directory than store-api - use your own types by generating schema with @onlishop/api-gen CLI
import type { operations } from "./api-types/adminApiTypes"; // or use your own types generated by @onlishop/api-gen CLI
...
import { createAdminAPIClient } from "@onlishop/api-client"; // we use different function to create admin api client

import { createAdminAPIClient } from "@onlishop/api-client";
import type { operations, Schemas } from "@onlishop/api-client/admin-api-types"; // we take default admin api types from different directory than store-api
import Cookies from "js-cookie";

export const adminApiClient = createAdminAPIClient<operations>({
  baseURL: "https://demo-frontends.onlishop.store/api",
...
Take a look at [example project using API Client](https://stackblitz.com/github/onlishop/frontends/tree/main/examples/new-api-client).
...
console.log(config.baseURL); // "https://demo-frontends.onlishop.store/store-api"
...
Full changelog for stable version is available [here](https://github.com/onlishop/frontends/blob/main/packages/api-client/CHANGELOG.md)
